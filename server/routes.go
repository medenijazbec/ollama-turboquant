...
func (s *Server) BenchScoreHandler(c *gin.Context) {
	...
	err = runner.Completion(c.Request.Context(), llm.CompletionRequest{
		...
		Logprobs:    true,
		TopLogprobs: max(0, req.TopLogprobs),
		Shift:       true,
		Truncate:    true,
	...
	perTokenLogprobs := observedLogprobs
	if !req.IncludeTokenLogprobs {
		perTokenLogprobs = nil
	}
	...
	resp := api.BenchScoreResponse{
		...
		PerTokenLogprobs:      perTokenLogprobs,
		Metrics: api.Metrics{
			...
			VReconstructionComputeDType:     final.VReconstructionComputeDType,
			SegmentedHeadActive:             final.SegmentedHeadActive,
			SegmentedHeadPlan:               final.SegmentedHeadPlan,
			AttentionSurfacePolicy:          final.AttentionSurfacePolicy,
			AttentionSurfacePolicyRequested: final.AttentionSurfacePolicyRequested,
			AttentionSurfacePolicyEffective: final.AttentionSurfacePolicyEffective,
			AttentionSurfaceBehavior:        final.AttentionSurfaceBehavior,
			AttentionSurfaceOverrideApplied: final.AttentionSurfaceOverrideApplied,
			AttentionSurfaceOverrideReason:  final.AttentionSurfaceOverrideReason,
			AttentionSurfaceClasses:         final.AttentionSurfaceClasses,
			QJLKRequested:                   final.QJLKRequested,
			QJLVRequested:                   final.QJLVRequested,
			QJLKEnabled:                     final.QJLKEnabled,
			QJLVEnabled:                     final.QJLVEnabled,
			ResidualTailTokens:              final.ResidualTailTokens,
			ExperimentalWeightQuantization:  final.ExperimentalWeightQuantization,
			ExperimentalWeightQuantPolicy:   final.ExperimentalWeightQuantPolicy,
			ExperimentalWeightQuantSource:   final.ExperimentalWeightQuantSource,
			ExperimentalWeightQuantActive:   final.ExperimentalWeightQuantActive,
		...
		if err := r.Completion(c.Request.Context(), llm.CompletionRequest{
			...
			res := api.GenerateResponse{
				...
				Metrics: api.Metrics{
					...
					KVCacheRequestedK:               cr.KVCacheRequestedK,
					KVCacheRequestedV:               cr.KVCacheRequestedV,
					ResolvedKVCacheType:             cr.ResolvedKVCacheType,
					ResolvedKVCacheTypeK:            cr.ResolvedKVCacheTypeK,
					ResolvedKVCacheTypeV:            cr.ResolvedKVCacheTypeV,
					KVAlgoResolved:                  cr.KVAlgoResolved,
					KVAlgoResolvedK:                 cr.KVAlgoResolvedK,
					KVAlgoResolvedV:                 cr.KVAlgoResolvedV,
					KVCacheBackend:                  cr.KVCacheBackend,
					KVCachePath:                     cr.KVCachePath,
					KVCachePathK:                    cr.KVCachePathK,
					KVCachePathV:                    cr.KVCachePathV,
					KVSymmetric:                     cr.KVSymmetric,
					KVAsymmetric:                    cr.KVAsymmetric,
					RequestedMode:                   cr.RequestedMode,
					EffectiveMode:                   cr.EffectiveMode,
					FallbackApplied:                 cr.FallbackApplied,
					KOnlyFallback:                   cr.KOnlyFallback,
					FallbackReason:                  cr.FallbackReason,
					TurboQuantPathKind:              cr.TurboQuantPathKind,
					NativeTurboQuantActive:          cr.NativeTurboQuantActive,
					ReferenceTurboQuantActive:       cr.ReferenceTurboQuantActive,
					BackendPackedKOwned:             cr.BackendPackedKOwned,
					BackendPackedVOwned:             cr.BackendPackedVOwned,
					BackendPackedKAvailable:         cr.BackendPackedKAvailable,
					BackendPackedVAvailable:         cr.BackendPackedVAvailable,
					NativeBackendReady:              cr.NativeBackendReady,
					NativeBackendBlocker:            cr.NativeBackendBlocker,
					FAEnabled:                       cr.FAEnabled,
					FARequiredForVTurbo:             cr.FARequiredForVTurbo,
					VTurboSupported:                 cr.VTurboSupported,
					DetectedHeadDim:                 cr.DetectedHeadDim,
					HeadDimSource:                   cr.HeadDimSource,
					ArchitectureClass:               cr.ArchitectureClass,
					SupportTier:                     cr.SupportTier,
					SupportReason:                   cr.SupportReason,
					UnsupportedReason:               cr.UnsupportedReason,
					HybridKVArchitecture:            cr.HybridKVArchitecture,
					NativeTurboQuantAllowed:         cr.NativeTurboQuantAllowed,
					PresetRequested:                 cr.PresetRequested,
					PresetResolved:                  cr.PresetResolved,
					PresetWarning:                   cr.PresetWarning,
					PairingValidated:                cr.PairingValidated,
					ExperimentalLane:                cr.ExperimentalLane,
					TQBlockSize:                     cr.TQBlockSize,
					TQLayoutKind:                    cr.TQLayoutKind,
					TQLayoutVersion:                 cr.TQLayoutVersion,
					TQGroupCount:                    cr.TQGroupCount,
					TQOriginalHeadDim:               cr.TQOriginalHeadDim,
					TQTailPad:                       cr.TQTailPad,
					VReconstructionComputeDType:     cr.VReconstructionComputeDType,
					SegmentedHeadActive:             cr.SegmentedHeadActive,
					SegmentedHeadPlan:               cr.SegmentedHeadPlan,
					AttentionSurfacePolicy:          cr.AttentionSurfacePolicy,
					AttentionSurfacePolicyRequested: cr.AttentionSurfacePolicyRequested,
					AttentionSurfacePolicyEffective: cr.AttentionSurfacePolicyEffective,
					AttentionSurfaceBehavior:        cr.AttentionSurfaceBehavior,
					AttentionSurfaceOverrideApplied: cr.AttentionSurfaceOverrideApplied,
					AttentionSurfaceOverrideReason:  cr.AttentionSurfaceOverrideReason,
					AttentionSurfaceClasses:         cr.AttentionSurfaceClasses,
					QJLKRequested:                   cr.QJLKRequested,
					QJLVRequested:                   cr.QJLVRequested,
					QJLKEnabled:                     cr.QJLKEnabled,
					QJLVEnabled:                     cr.QJLVEnabled,
					ResidualTailTokens:              cr.ResidualTailTokens,
					ExperimentalWeightQuantization:  cr.ExperimentalWeightQuantization,
					ExperimentalWeightQuantPolicy:   cr.ExperimentalWeightQuantPolicy,
					ExperimentalWeightQuantSource:   cr.ExperimentalWeightQuantSource,
					ExperimentalWeightQuantActive:   cr.ExperimentalWeightQuantActive,
			...
			err := r.Completion(ctx, llm.CompletionRequest{
				...
				res := api.ChatResponse{
					...
					Metrics: api.Metrics{
						...
						KVCacheRequestedK:               r.KVCacheRequestedK,
						KVCacheRequestedV:               r.KVCacheRequestedV,
						ResolvedKVCacheType:             r.ResolvedKVCacheType,
						ResolvedKVCacheTypeK:            r.ResolvedKVCacheTypeK,
						ResolvedKVCacheTypeV:            r.ResolvedKVCacheTypeV,
						KVAlgoResolved:                  r.KVAlgoResolved,
						KVAlgoResolvedK:                 r.KVAlgoResolvedK,
						KVAlgoResolvedV:                 r.KVAlgoResolvedV,
						KVCacheBackend:                  r.KVCacheBackend,
						KVCachePath:                     r.KVCachePath,
						KVCachePathK:                    r.KVCachePathK,
						KVCachePathV:                    r.KVCachePathV,
						KVSymmetric:                     r.KVSymmetric,
						KVAsymmetric:                    r.KVAsymmetric,
						RequestedMode:                   r.RequestedMode,
						EffectiveMode:                   r.EffectiveMode,
						FallbackApplied:                 r.FallbackApplied,
						KOnlyFallback:                   r.KOnlyFallback,
						FallbackReason:                  r.FallbackReason,
						TurboQuantPathKind:              r.TurboQuantPathKind,
						NativeTurboQuantActive:          r.NativeTurboQuantActive,
						ReferenceTurboQuantActive:       r.ReferenceTurboQuantActive,
						BackendPackedKOwned:             r.BackendPackedKOwned,
						BackendPackedVOwned:             r.BackendPackedVOwned,
						BackendPackedKAvailable:         r.BackendPackedKAvailable,
						BackendPackedVAvailable:         r.BackendPackedVAvailable,
						NativeBackendReady:              r.NativeBackendReady,
						NativeBackendBlocker:            r.NativeBackendBlocker,
						FAEnabled:                       r.FAEnabled,
						FARequiredForVTurbo:             r.FARequiredForVTurbo,
						VTurboSupported:                 r.VTurboSupported,
						DetectedHeadDim:                 r.DetectedHeadDim,
						HeadDimSource:                   r.HeadDimSource,
						ArchitectureClass:               r.ArchitectureClass,
						SupportTier:                     r.SupportTier,
						SupportReason:                   r.SupportReason,
						UnsupportedReason:               r.UnsupportedReason,
						HybridKVArchitecture:            r.HybridKVArchitecture,
						NativeTurboQuantAllowed:         r.NativeTurboQuantAllowed,
						PresetRequested:                 r.PresetRequested,
						PresetResolved:                  r.PresetResolved,
						PresetWarning:                   r.PresetWarning,
						PairingValidated:                r.PairingValidated,
						ExperimentalLane:                r.ExperimentalLane,
						TQBlockSize:                     r.TQBlockSize,
						TQLayoutKind:                    r.TQLayoutKind,
						TQLayoutVersion:                 r.TQLayoutVersion,
						TQGroupCount:                    r.TQGroupCount,
						TQOriginalHeadDim:               r.TQOriginalHeadDim,
						TQTailPad:                       r.TQTailPad,
						VReconstructionComputeDType:     r.VReconstructionComputeDType,
						SegmentedHeadActive:             r.SegmentedHeadActive,
						SegmentedHeadPlan:               r.SegmentedHeadPlan,
						AttentionSurfacePolicy:          r.AttentionSurfacePolicy,
						AttentionSurfacePolicyRequested: r.AttentionSurfacePolicyRequested,
						AttentionSurfacePolicyEffective: r.AttentionSurfacePolicyEffective,
						AttentionSurfaceBehavior:        r.AttentionSurfaceBehavior,
						AttentionSurfaceOverrideApplied: r.AttentionSurfaceOverrideApplied,
						AttentionSurfaceOverrideReason:  r.AttentionSurfaceOverrideReason,
						AttentionSurfaceClasses:         r.AttentionSurfaceClasses,
						QJLKRequested:                   r.QJLKRequested,
						QJLVRequested:                   r.QJLVRequested,
						QJLKEnabled:                     r.QJLKEnabled,
						QJLVEnabled:                     r.QJLVEnabled,
						ResidualTailTokens:              r.ResidualTailTokens,
						ExperimentalWeightQuantization:  r.ExperimentalWeightQuantization,
						ExperimentalWeightQuantPolicy:   r.ExperimentalWeightQuantPolicy,
						ExperimentalWeightQuantSource:   r.ExperimentalWeightQuantSource,
						ExperimentalWeightQuantActive:   r.ExperimentalWeightQuantActive,
