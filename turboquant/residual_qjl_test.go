...
func TestResidualSketchDeterministic(t *testing.T) {
	a := encodeResidual([]float32{1, 2, 3, 4}, []float32{0, 0, 0, 0}, PresetTQ25, 99)
	b := encodeResidual([]float32{1, 2, 3, 4}, []float32{0, 0, 0, 0}, PresetTQ25, 99)
...
func TestResidualDotCorrectionDeterministicAndFinite(t *testing.T) {
	...
	sketch := encodeResidual(rotated, approx, PresetTQ35, 789)
