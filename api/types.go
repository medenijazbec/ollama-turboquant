...
type Runner struct {
	...
	KVCacheBackend                 string `json:"kv_cache_backend,omitempty"`
	TurboQuantQJLK                 *bool  `json:"turboquant_qjl_k,omitempty"`
	TurboQuantQJLV                 *bool  `json:"turboquant_qjl_v,omitempty"`
	TurboQuantResidualTailTokens   int    `json:"turboquant_residual_tail_tokens,omitempty"`
	TurboQuantAllowSegmentedHeads  *bool  `json:"turboquant_allow_segmented_heads,omitempty"`
	TurboQuantSurfacePolicy        string `json:"turboquant_surface_policy,omitempty"`
	ExperimentalWeightQuantization string `json:"experimental_weight_quantization,omitempty"`
	ExperimentalWeightQuantPolicy  string `json:"experimental_weight_quant_policy,omitempty"`
	ExperimentalWeightQuantSource  string `json:"experimental_weight_quant_source,omitempty"`
}
